...
import Aşk1 from "../components/Aşk1";
import Aşk2 from "../components/Aşk2";
import Aşk3 from "../components/Aşk3";
...
export default function Home() {
  ...
  const {
    data,
    isLoading,
  } = SWR(`https://api.lanyard.rest/v1/users/1228030894649118823`);
              ...
              <div className="flex justify-between items-start pt-2">
                <div>
                  <div>
                    ...
                    <span className="text-[#ff2276] ml-3"> 31.07.2023 ∞ </span>
                  </div>
                  <p className="mt-4 ml-2 text-2xl text-[#ffffff]"> Aklına Ben Gelicem. </p>
                ...
                <div className="w-96 lg:w-48 indicator flex justify-end">
                  {!isLoading && (
                    <>
                      <Image src={`https://cdn.discordapp.com/avatars/${discordData?.discord_user.id}/${discordData?.discord_user.avatar}?size=1024`} alt="Wizyx" height={1024} width={1024} className="rounded-full lg:w-20 lg:h-20 h-34 w-96" />
                      <div className={classNames({
                        "indicator-item indicator-bottom indicator-end transition-all duration-200 badge mb-2 mr-3": true,
