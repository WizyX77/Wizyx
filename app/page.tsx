...
export default function Home() {
  ...
  const {
    data,
    isLoading,
  } = SWR(`https://api.lanyard.rest/v1/users/972557059860099082`);
              ...
              <div className="flex justify-between items-start pt-2">
                <div>
                  <div>
                    ...
                    <span className="text-[#ff2276] ml-2"> Kullanıcı Adı: {!isLoading && `@${discordData?.discord_user.username}`}</span>
                  </div>
                  <p className="mt-4 ml-2 text-[#86ec53]"> Bot / Web Developer & Content Creator <p> Professional Pubg Mobile Player! S2G Here Academy Leader. </p></p>
