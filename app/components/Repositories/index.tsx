...
export default function Repositories() {
  ...
  const {
    data,
    isLoading,
  } = SWR(`https://api.github.com/users/WizyX77/repos`);
    ...
    <>
      {isLoading ? (
        ...
        <motion.div
          ...
          <h2 className="text-3xl"> Projelerim </h2>
          <p className="text-[#a7a7a7]"> GitHub Üzerinde Yaptığım Tüm Projelerim. </p>
          ...
          <motion.div
            ...
            {repositories.filter((repo: any) => repo.name !== "WizyX77").map((repo: any, index: number) => (
